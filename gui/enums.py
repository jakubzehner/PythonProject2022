...
# Plik zawierający enumy, identyczny jest na serwerze, dla zachowania kompatybilności i zachowania kontekstu, zamiast
# używania magicznych numerków, które nie wiadomo co oznaczają
